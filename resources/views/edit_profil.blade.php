            ...
            <div class="section-menu-admin" id="section-menu">
                ...
                <div class="form_add_pengguna">
                    ...
                    <div class="input_gambar">
                        <label for="uploadgambar">Tambahkan Foto Profil</label>
                        <div class="input_img">
                            <input
                                type="file"
                                name="gambar"
                        ...
                        @if ($user->foto_profil)
                            <img src="{{ asset('storage/' . $user->foto_profil) }}" alt="Foto Profil" style="width: 100px;">
                        @endif
                    </div>
                    <div class="button_submit">
                        <button type="submit" name="button_update_profil">Submit</button>
                    </div>
                    </form>
